...
Primary colors are used for UI elements that you want to emphasize and embody product characteristics. The default brand color of Velo UI is teal. You can override default brand color with `brandColors` Props in `VeloProvider`.
